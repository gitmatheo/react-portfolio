...
class About extends Component {
  constructor(props) {
    ...
    bieżąco z trendami i postępami w branży. Ukończyłem Bootcamp „Zostań
    Front-End Developerem” w CodersLab,
  ...
  componentDidMount() {
    this.myTween = new ScrollMagic.Scene({
      triggerElement: this.aboutElement,
      triggerHook: 0.6,
      offset: "-500px"
    })
      .setTween(TweenMax.from(this.aboutElement, 1, { opacity: 0, x: -100 }))
      .addIndicators()
      ...
      <ProjectsContext.Consumer>
        {({ language }) => (
          <SectionAbout className="about" id="about">
            <div className="about__container" ref={div => (this.aboutElement = div)}>
              ...
              <div className="about__content">
                ...
                {language === "pl" ? ReactHtmlParser(pl) : ReactHtmlParser(en)}
              </div>
            </div>
          </SectionAbout>
        )}
